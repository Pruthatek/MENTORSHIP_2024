...
urlpatterns = [
    ...
    path("MainMentorship/passoutStudent", TemplateView.as_view(template_name='index.html')),
    ...
    path("Hod/passoutStudentH", TemplateView.as_view(template_name='index.html')),
    path("Hod/passoutStudentH/passoutDetailsH", TemplateView.as_view(template_name='index.html')),
    ...
    path("Principal/passoutStudentP", TemplateView.as_view(template_name='index.html')),
    path("Principal/passoutStudentP/passoutStudentDetails", TemplateView.as_view(template_name='index.html')),
    ...
    path("Chairman/passoutStudent", TemplateView.as_view(template_name='index.html')),
    ...
    path("Chairman/passoutStudent/passoutStudentDetails", TemplateView.as_view(template_name='index.html')),
