...
exports.createFaculty = async (req, res) => {
    try {
        const { surname, facultyName, fatherName, motherName, email, phoneNumber, OtherphoneNumber, facultyType, collegeName, departmentName, subDivisionName, joiningData, salary, education } = req.body

        if (!surname || !facultyName || !fatherName || !email || !phoneNumber || !facultyType || !joiningData || !salary) {
        ...
        if (departmentName) {
            ...
            tempData = { ...tempData, departmentName: tempData.departmentName }
...
exports.createSubDivision = async (req, res) => {
    try {
        ...
        if (!tempDepartment) {
            throw new Error("No department was found by given department id")
        }
