...
const Membership = () => {
  ...
  const { mentorFormDataForStudentPage, setMentorFormDataForStudentPage, loggedStudent, setLoggedStudent } = useContext(mentoringDataContext);
  ...
  // send data to mentoring api

  function sendData() {

    const tmepData = {
      "name": mentorFormDataForStudentPage?.basicinfo?.name,
      // "study_semester": mentorFormDataForStudentPage?.studentHistory?.  ,
      "enrollment": mentorFormDataForStudentPage?.basicinfo?.enrollmentno,
      // "student_photo": mentorFormDataForStudentPage?.basicinfo?.startyear,
      "father_name": mentorFormDataForStudentPage?.studentHistory?.fathername,
      // "father_photo": mentorFormDataForStudentPage?.studentHistory?.   ,
      "mother_name": mentorFormDataForStudentPage?.studentHistory?.mothername,
      // "mother_photo": mentorFormDataForStudentPage?.studentHistory?.   ,
      "mentoring_started_year": mentorFormDataForStudentPage?.basicinfo?.startyear,
      // "department": mentorFormDataForStudentPage?.basicinfo?.department,
      // "division": mentorFormDataForStudentPage?.basicinfo?.batchdiv,
      "email": mentorFormDataForStudentPage?.studentHistory?.email,
      "caste": mentorFormDataForStudentPage?.studentHistory?.caste,
      "gender": mentorFormDataForStudentPage?.studentHistory?.gender,
      "weight": mentorFormDataForStudentPage?.studentHistory?.weight,
      "height": mentorFormDataForStudentPage?.studentHistory?.height,
      "address": mentorFormDataForStudentPage?.studentHistory?.address,
      "date_of_birth": mentorFormDataForStudentPage?.studentHistory?.dob,
      "mentor_name": mentorFormDataForStudentPage?.basicinfo?.sem1_mentorname,
      "city": mentorFormDataForStudentPage?.studentHistory?.city,
      "state": mentorFormDataForStudentPage?.studentHistory?.state,
      "pincode": mentorFormDataForStudentPage?.studentHistory?.pincode,
      // "hobbies": mentorFormDataForStudentPage?.studentHistory?.hobbies   ,
      "nationality": mentorFormDataForStudentPage?.studentHistory?.nationality,
      // "sport": mentorFormDataForStudentPage?.studentHistory?.   ,
      "overall_10th": mentorFormDataForStudentPage?.studentHistory?.hsc,
      "overall_12th": mentorFormDataForStudentPage?.studentHistory?.ssc,
      "diploma": mentorFormDataForStudentPage?.studentHistory?.diploma,
      "student_contact": toString(mentorFormDataForStudentPage?.studentHistory?.studentno),
      "father_contact": toString(mentorFormDataForStudentPage?.studentHistory?.fatherno),
      "mother_contact": toString(mentorFormDataForStudentPage?.studentHistory?.motherno),
      "father_occupation": mentorFormDataForStudentPage?.studentHistory?.foccupation,
      "mother_occupation": mentorFormDataForStudentPage?.studentHistory?.moccupation,
      "activity": mentorFormDataForStudentPage?.activity,
      "project": mentorFormDataForStudentPage?.membership,
      "membership_in_organization": mentorFormDataForStudentPage?.seminars,
    ...
    formDataForApi.append("enrollment", mentorFormDataForStudentPage.basicinfo.enrollmentno);
    formDataForApi.append("data", JSON.stringify(tmepData));




    axios({
      url: process.env.REACT_APP_SERVER + "/api/editStudent/",
      method: "POST",
      headers: {
