...
import Activities from './MentorFormComponents/Activities';
import Basicinfo from './MentorFormComponents/Basicinfo';
import Membership from './MentorFormComponents/Membership';
import Seminar from './MentorFormComponents/Seminar';
import StudentHistory from './MentorFormComponents/StudentHistory';

function MentorFormStudent() {
...
export default MentorFormStudent;
