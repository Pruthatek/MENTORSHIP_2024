        ...
        <form className=' overflow-auto '>
          <div className="flex space-x-[8rem] py-5 h-full overflow-auto  items-center justify-center">
            <div>
              <button
                type="button"
                className=" mr-2 text-white text-[16px] font-inter   bg-[#159BD6] rounded-[5px]  font-bold px-4 py-2 mb-2 leading-[19.36px] tracking-[2%] capitalize"
              >
                Upload Result Copy
              </button>
            </div>
          ...
          <div className="flex items-center justify-center px-2 py-2">
            <button
              type="button"
              className="text-white text-[16px] font-inter    bg-[#16376E] rounded-[5px]  font-bold w-[100%] py-2 mb-2 leading-[19.36px] tracking-[2%] capitalize"
            >
