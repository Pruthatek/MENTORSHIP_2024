...
const Basicinfo = ({ handleNextStep, list }) => {
  ...
  const { stepNo, setStepNo, MentorFormData, setMentorFormData } = useContext(mentoringDataContext);
  ...
  const [values, setValues] = React.useState({
    ...
    enrollmentno: MentorFormData?.EnrollmentNumber,
    sem1_mentorname: MentorFormData?.division?.mentorId?.facultyFullName,
    sem2_mentorname: MentorFormData?.division?.mentorId?.facultyFullName,
    sem3_mentorname: MentorFormData?.division?.mentorId?.facultyFullName,
    sem4_mentorname: MentorFormData?.division?.mentorId?.facultyFullName,
    sem5_mentorname: MentorFormData?.division?.mentorId?.facultyFullName,
    sem6_mentorname: MentorFormData?.division?.mentorId?.facultyFullName,
    sem7_mentorname: MentorFormData?.division?.mentorId?.facultyFullName,
    startyear: MentorFormData?.mentoringStartingYear,
    department: MentorFormData?.department?.departmentName,
    batchdiv: MentorFormData?.division?.subDivisionName
