...
const StudentHistory = ({ handleNextStep, handlePrevStep }) => {
  ...
  const { formData, dataM, setDataM, setFormData, stepNo, setStepNo, MentorFormData, setMentorFormData } = useContext(mentoringDataContext);
  ...
  const [values, setValues] = React.useState({
    studentname: MentorFormData?.studentName,
    date: '',
    emailId: MentorFormData?.email,
    dob: MentorFormData?.dateOfBirth,
    caste: MentorFormData?.caste,
    gender: tempGender,
    weight: MentorFormData?.weight,
    height: MentorFormData?.height,
    address: MentorFormData?.address,
    city: MentorFormData?.city,
    state: MentorFormData?.state,
    pincode: MentorFormData?.pincode,
    hobbies: '',
    selectnantion: MentorFormData?.country,
    sports: '',
    ssc: MentorFormData?.ssc,
    hsc: MentorFormData?.hsc,
    diploma: '',
    studentno: MentorFormData?.studentPhoneNumber,
    fatherno: MentorFormData?.fatherPhoneNumber,
    motherno: MentorFormData?.guradianPhone,
    fathername: MentorFormData?.fatherName,
    foccupation: MentorFormData?.fatherOcc,
    mothername: MentorFormData?.motherName,
    moccupation: MentorFormData?.motherOcc,
  ...
  const validateAll = () => {
    const validations = { studentname: "", date: "", emailId: "", dob: "", caste: "", gender: "", weight: "", height: "", address: "", city: "", state: "", pincode: "", selectnantion: "", studentno: "", fatherno: "", motherno: "", fathername: "", mothername: "" };

    let isValid = true;
    if (!studentname) {
      //validations.firstName = 'First Name is  '
      alert("student Name is  " + validations.studentname);
      isValid = false;
    }
              ...
              <div className="flex justify-between items-center px-10 flex-row py-5">
                ...
                <div className="flex flex-row">
                  ...
                  <input
                    ...
                    className="hover:border-[2px] hover:border-[#159BD6] w-[150px] h-[40px] rounded-[5px]  uppercase border border-[#CBCBCB] bg-[#FFFFFF] font-inter p-3 font-medium text-[16px] leading-[19.36px] tracking-[2%] focus:outline-none"
