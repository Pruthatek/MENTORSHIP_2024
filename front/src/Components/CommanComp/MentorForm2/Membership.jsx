...
const Membership = () => {
  ...
  function sendData() {
    ...
    const activity = JSON.stringify(formData.activity[0]);
    const project = JSON.stringify(formData.seminars[0]);
    const membership_in_organization = JSON.stringify(formData.membership[0]);




    const formDataForApi = new FormData();
    formDataForApi.append("name", formData.basicinfo.name);
    formDataForApi.append("enrollment", formData.basicinfo.enrollmentno);
    formDataForApi.append("mentoring_started_year", formData.basicinfo.startyear);
    formDataForApi.append("departments", formData.basicinfo.department);
    formDataForApi.append("division", formData.basicinfo.batchdiv);

    // files
    formDataForApi.append("student_photo", formData.student_photo);
    formDataForApi.append("father_photo", formData.father_photo);
    formDataForApi.append("mother_photo", formData.mother_photo);

    formDataForApi.append("date_of_birth", formData.studentHistory.dob);
    formDataForApi.append("height", formData.studentHistory.height);
    formDataForApi.append("weight", formData.studentHistory.weight);
    formDataForApi.append("gender", formData.studentHistory.gender);
    formDataForApi.append("caste", formData.studentHistory.caste);
    formDataForApi.append("address", formData.studentHistory.address);
    formDataForApi.append("city", formData.studentHistory.city);
    formDataForApi.append("state", formData.studentHistory.state);
    // formDataForApi.append("country", formData.studentHistory.country);
    formDataForApi.append("country", 'USA');
    formDataForApi.append("overall_10th", formData.studentHistory.hsc);
    formDataForApi.append("overall_12th", formData.studentHistory.ssc);
    formDataForApi.append("diploma", formData.studentHistory.diploma);
    formDataForApi.append("student_contact", formData.studentHistory.studentno);
    formDataForApi.append("father_contact", formData.studentHistory.fatherno);
    formDataForApi.append("mother_contact", formData.studentHistory.motherno);
    formDataForApi.append("father_occupation", formData.studentHistory.foccupation);
    formDataForApi.append("mother_occupation", formData.studentHistory.moccupation);
    formDataForApi.append("father_name", formData.studentHistory.fathername);
    formDataForApi.append("mother_name", formData.studentHistory.mothername);

    formDataForApi.append("activity", activity);
    formDataForApi.append("project", project);
    formDataForApi.append("membership_in_organization", membership_in_organization);

    formDataForApi.append("attendence", 24);
    formDataForApi.append("pincode", 2455774);

    axios({
      url: process.env.REACT_APP_SERVER + "/api/mentorshipForm/",
      method: "POST",
      headers: {
