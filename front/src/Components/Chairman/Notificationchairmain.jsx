...
function Notificationchairmain() {
  ...
  return (
    <>
      ...
      <div className=" flex flex-col w-full h-full  gap-x-2    pl-[0px]  ">
          ...
          isLoading ? <>
            ...
            <div className=" w-full    h-full flex flex-col justify-between items-start">
              <div className=" w-full flex  flex-row  h-full">
                ...
                {/* send notification secetion start */}
                <div className="bg-white h-full w-[50%] flex flex-col justify-between items-start  ml-[5px] p-5 rounded-lg ">
                  <div className="    w-full">
                    <h1 className="text-[color:var(--02,#47A5E4)] text-[20px] font-Raleway not-italic font-bold leading-[normal] tracking-[1.1px]">Send Notification</h1>
                    ...
                    <div className="flex flex-col gap-y-4">
                      ...
                      <div className="flex flex-row gap-x-6 items-center">
                        ...
                        <input type="text" name="from_name" className="w-full py-2 px-2 border-[color:var(--Desable-Grey,#BDBDBD)]  rounded-[5px] border-[0.3px] border-solid"></input>
                      </div>
                      <div className="flex flex-row gap-x-2 items-center">
                        ...
                        <input type="text" name="from_email" className="w-full py-2 px-2  border-[color:var(--Desable-Grey,#BDBDBD)]  rounded-[5px] border-[0.3px] border-solid"></input>
                      </div>
                  ...
                  <div className=" w-full  h-full relative">
                    <div className="  absolute h-full w-full py-2">
                      ...
                      <textarea typeof="text" name="message" placeholder="Write message here" className=" p-2 w-full    text-[14px] font-Inter not-italic font-medium leading-[normal] tracking-[0.28px] capitalize  h-full  resize-none rounded-[5px] bg-[#F5F5F5]" ></textarea>
                    </div>
                  </div>
                ...
                {/* send notification secetion end */}
