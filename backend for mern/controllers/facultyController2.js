...
exports.updateFaculty = async (req, res) => {
    try {
        ...
        const { surname, facultyName, fatherName, motherName, phoneNumber, OtherphoneNumber, facultyType, email, birthDate, password, collegeName, departmentName, image, salary, education } = req.body;
