...
const StudentHistory = ({ handleNextStep, handlePrevStep }) => {
  ...
  const [values, setValues] = React.useState({
    studentname: dataM.studentDetails.name,
    // date: dataM.studentDetails.name,
    data: new Date().toLocaleDateString,
    emailId: dataM.studentDetails.email,
    dob: dataM.studentDetails.date_of_birth,
    caste: dataM.studentDetails.caste,
    gender: dataM.studentDetails.gender,
    weight: dataM.studentDetails.weight,
    height: dataM.studentDetails.height,
    address: dataM.studentDetails.address,
    city: dataM.studentDetails.city,
    state: dataM.studentDetails.state,
    pincode: dataM.studentDetails.pincode,
    hobbies: '',
    selectnantion: dataM.studentDetails.nationality,
    sports: '',
    ssc: dataM.studentDetails.overall_10th,
    hsc: dataM.studentDetails.overall_12th,
    diploma: dataM.studentDetails.diploma,
    studentno: dataM.studentDetails.student_contact,
    fatherno: dataM.studentDetails.father_contact,
    motherno: dataM.studentDetails.mother_contact,
    fathername: dataM.studentDetails.father_name,
    foccupation: dataM.studentDetails.father_occupation,
    mothername: dataM.studentDetails.mother_name,
    moccupation: dataM.studentDetails.mother_occupation
