...
const FeesDetails = () => {
    ...
    const [specificMentorData, setSpecificMentorData] = useState([]);
    ...
    const onOptionChangeHandler = (event) => {
        ...
        function studentDataApi() {
            ...
            axios({
                url: process.env.REACT_APP_SERVER + "/api/fesscheck/",
                method: "POST",
                headers: {
                ...
                .then((e) => {
                    ...
                    e.data.map((e) => {
                        ...
                        let b = dataM.nameOfMentor;
                        if (a[0].fields.mentor_name == b) {
                            c = [...c, e]
        ...
        axios({
            ...
            .then((e) => {
                ...
                e.data.map((e) => {
                    ...
                    let a = JSON.parse(e.student_data);
                    // console.log(a[0].fields);
                    // let b = localStorage.getItem('nameOfMentor');
                    let b = dataM.nameOfMentor;
                    if (a[0].fields.mentor_name == b) {
                        c = [...c, e]
    ...
    const handleSearchChange = (e) => {
        ...
        setSearchTerm(term)
        let newfilterdata = specificMentorData.filter((e) => {
            let adata = JSON.parse(e.student_data)

            let a = adata[0].fields.name;
            let b = adata[0].fields.enrollment;
            console.log(adata)
                    ...
                    <div className="   ">
                        <div className="flex flex-row justify-between items-center px-5">
                            ...
                            <div className="flex justify-center  items-center">
                                <h2 onClick={() => {
                                    console.log(specificMentorData)
                                        ...
                                        <table className="table-auto1 table-auto min-w-[100%] max-h-[250px] overflow-y-scroll overflow-hidden  border-collapse  ">
                                            ...
                                            <tbody className=''>
                                                {filteredData.map((id, index) => {
                                                    // let a=JSON.parse(e.student_data);
                                                    // console.log(a[0].fields);
                                                    let adata = JSON.parse(id.student_data)
                                                    let feesStat = id.payment_status == 'Not paid in full' ? "Not Paid" : "Full Paid";


                                                    return (
                                                        <tr
                                                            key={index}
                                                            onClick={() => StudentClicked(adata[0].fields)}
                                                        ...
                                                        >
                                                            ...
                                                            <td className="px-[1rem] whitespace-nowrap border-[2px] border-[#47A5E4]">
                                                                <div className="">
                                                                    <div className={feesStat == "Not Paid" ? "text-[#ff2323]" : "" + "text-center text-[#00BE35] text-[16px] font-inter not-italic font-bold leading-[normal] tracking-[0.32px] capitalize"}>
